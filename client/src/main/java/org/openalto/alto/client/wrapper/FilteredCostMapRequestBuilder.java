...
public class FilteredCostMapRequestBuilder extends PostRequestBuilder {

    public FilteredCostMapRequestBuilder(Client client,
    ...
    public boolean canRequest(ResourceEntry entry) {
        if ((entry == null) || (entry.getType() == null))
            return false;
        return (entry.getType().equals(ResourceType.FILTERED_COST_MAP_TYPE));
    }
